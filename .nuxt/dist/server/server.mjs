...
import require$$0, { reactive, getCurrentInstance, ref, computed, defineComponent, resolveComponent, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext, h, Transition, Suspense, createCommentVNode, shallowRef, defineAsyncComponent, mergeProps, createTextVNode, toDisplayString as toDisplayString$1, createApp, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderStyle } from "vue/server-renderer";
...
const vueuseHead_be8a9e40 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_7aa3ae58 = defineNuxtPlugin((nuxtApp) => {
...
const NuxtNestedPage = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8]]);
const layouts = {};
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7]]);
const routes = [
  {
    "name": "find",
    "path": "/find",
...
const router_2e80d4cb = defineNuxtPlugin((nuxtApp) => {
...
const nitroClient_328ce62a = () => {
};
const components = {
  "CommonBanner": defineAsyncComponent(() => Promise.resolve().then(function() {
    return banner$1;
  }).then((c) => c.default || c)),
  "CommonFooter": defineAsyncComponent(() => Promise.resolve().then(function() {
    return Footer;
  }).then((c) => c.default || c))
};
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "com-footer" }, _attrs))}><ul class="footer-ul"><!--[-->`);
  ssrRenderList($data.list, (item, i) => {
    _push(`<li>`);
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_common_footer = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_router_view, null, null, _parent));
  _push(ssrRenderComponent(_component_common_footer, null, null, _parent));
  _push(`</div>`);
}
...
const index$4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
...
const _sfc_main$2 = {
  ...
  setup() {
    let bannerList = ref([]), newGoodsList = ref([]);
    setTimeout(() => {
      bannerList.value = [
        {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><header> \u4E3B\u9875 </header><div class="main-content"><div class="banner">`);
  _push(ssrRenderComponent(_component_swiper, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList($setup.bannerList, (item, i) => {
          _push2(ssrRenderComponent(_component_swiper_slide, { key: i }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="banner-item" style="${ssrRenderStyle({ backgroundImage: `url('${item.url}')` })}"${_scopeId2}></div>`);
              } else {
                return [
                  createVNode("div", {
                    class: "banner-item",
        ...
        return [
          (openBlock(true), createBlock(Fragment, null, renderList($setup.bannerList, (item, i) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_swiper, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList($props.imgList, (item, i) => {
          _push2(ssrRenderComponent(_component_swiper_slide, { key: i }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div style="${ssrRenderStyle({ item })}"${_scopeId2}></div>`);
              } else {
                return [
                  createVNode("div", {
                    style: { item }
        ...
        return [
          (openBlock(true), createBlock(Fragment, null, renderList($props.imgList, (item, i) => {
            return openBlock(), createBlock(_component_swiper_slide, { key: i }, {
              default: withCtx(() => [
                createVNode("div", {
                  style: { item }
